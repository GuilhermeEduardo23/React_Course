...
const HookUseEffect = () => {
    ...
    useEffect(() => {
        console.log("Serei executado apenas uma vez, pois estou com array de dependência vazio no meu useEffect.");
    }, []);
    ...
    return <div>
        ...
        <button onClick={() => setAnotherNumber(Math.random())}>Clique para mudar o number!</button>
        <hr />
    </div>
}
